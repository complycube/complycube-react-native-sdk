...
import {
//requiredDocuments,
requiredStages, schemesColors, stages } from './constants';
class ComplyCubeRN {
  constructor() {
  ...
  _validateSettings(settings) {
    ...
    const _requiredStages = settings.stages.filter(stage => requiredStages.includes(typeof stage === 'object' && stage.name ? stage.name : stage));
