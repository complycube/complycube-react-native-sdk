...
# Table of contents
- [ComplyCube React native SDK](#complycube-react-native-sdk)
...
First, setup the JS React Native library before doing the setup of the native libraries.
...
```
3. Install the React Native library:
